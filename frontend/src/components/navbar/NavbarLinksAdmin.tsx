...
// Assets
import navImage from '/public/img/auth/auth.png';
    ...
    >
      ...
      <Menu>
        ...
        >
          ...
          <Flex flexDirection="column">
            <Link w="100%" href="https://nalcoindia.com/pro">
            ...
            <Link
              w="100%"
              href="https://nalcoindia.com/documentation/docs/introduction"
            >
              <Button
                w="100%"
                h="44px"
            ...
            <Link
              w="100%"
              href="https://github.com/nalcoindia/nalcoindia-chakra-nextjs"
            >
              {/* <Button
                w="100%"
                h="44px"
